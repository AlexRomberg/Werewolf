...
describe("GameState", () => {
    ...
    it("should deserialize correctly", () => {
        ...
        expect(connections.find(c => c.ConnectionType === ConnectionTypes.Trust)?.From).toBe(people[2]);
        expect(connections.find(c => c.ConnectionType === ConnectionTypes.Trust)?.To).toBe(people[1]);
